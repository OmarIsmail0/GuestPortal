      ...
      <Grid2 size={12} container>
        <Grid2 size={8}>
          ...
          <Typography sx={{ textAlign: "center", mt: 4 }} fontSize={16}>
            {door_2.ElementNames[0]}
          </Typography>
        </Grid2>
        <Grid2 size={4}>
          <CardMedia component="img" image={door_2.AssetName} alt={door_2.ElementNames[0]} />
        </Grid2>
      </Grid2>
